                                                ...
                                                <td>
                                                    <div>
                                                        <button
                                                            ...
                                                            onClick={() => getDepId(item.hospcode)}
                                                        >
                                                            <Edit className="top-menu__sub-icon " size={14} />
                                                        </button>
                                                        <Popconfirm
                                                            title="คุณต้องการลบหรือไม่"
                                                            onConfirm={() => onDelete(item.hospcode)}
                                                            // onCancel={cancel}
                                                            okText="ตกลง"
                                                            cancelText="ออก"
                                                        >
                            ...
                            >
                                <Form.Item label="รหัส" rules={[{ required: true }]}>
                                    <Input
                                        ...
                                        onChange={(e) => {
                                            setFormData({ ...formData, hospcode: e.target.value });
                                        }}
                                    />
                                </Form.Item>
                                <Form.Item label="ชื่อหน่วยงาน" rules={[{ required: true }]}>
                                    <Input
                                        value={formData.name}
                                        onChange={(e) => {
